...
<br> <br>
➪ After this, you'll have to configure the Database. In the project, select the "Sql_Scripts" folder (Make sure the 'Show all files' option in the Solution menu is enabled).<br>
